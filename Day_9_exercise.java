...
public class Day_9_exercise {
    ...
    public static void case_state (String letter) throws Exception{
        if (Character.isUpperCase(letter.charAt(0))) {
            throw new Exception("please enter the letter in lower case");
        }
    }
    public static void positive_number (int num) throws Exception{
        if (num < 0) {
            throw new Exception("please enter a positive number");
        }
    }
    public static void geometric_shapes_measurements (float num) throws Exception{
        if (num < 0) {
            throw new Exception("The geometric shapes measurements cannot be negative");
        }
    }
    public static void absolute_zero (float num) throws Exception{
        if (num < -273.16) {
            throw new Exception("it is impossible there is temperature in the universe less than -273.16");
        }
    }
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            geometric_shapes_measurements(radius);
       ...
       /* 9.Write a Java program that takes a string and a number from the user,then prints the
        ...
        try {
            ...
            geometric_shapes_measurements(height);
            System.out.println("Enter a width of the rectangle : ");
            float width = scan.nextFloat();
            geometric_shapes_measurements(width);
